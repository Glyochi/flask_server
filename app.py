...
if __name__ == '__main__':
    socketio.run(app, debug=True, port=int(os.environ.get('PORT', 8080)))
...
def detectFaceVanilla(type_and_base64_image):
    ...
    GlyLibrary.findAndDrawFacesVanilla(img, '/app/Flask2/glyLib/classifier/haarcascade_frontalface_default.xml')
...
def detectFaceVanilla_coordinates(type_and_base64_image):
    ...
    temp = GlyLibrary.findAndDrawFacesVanilla_coordinates(img, '/app/Flask2/glyLib/classifier/haarcascade_frontalface_default.xml')
